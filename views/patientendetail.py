...
def _inject_patient_detail_button_styles() -> None:
    """Injiziert auf dieser Seite nur die rote Hervorhebung für die Löschaktion."""
    st.markdown(
        """
        <style>
...
def oeffne_patientbearbeitung_aus_detail(patient_id: str) -> None:
    """Öffnet die Patientenbearbeitung innerhalb der sichtbaren Übersichtsseite."""
...
def zeige_arbeitskontext() -> None:
    """Zeigt den empfohlenen Ablauf für die weitere Bearbeitung des Patienten."""
    st.info(
        "Empfohlener Ablauf: zuerst Stammdaten prüfen, danach Material für diesen "
...
def zeige_material_log(materialien: list[Material]) -> None:
    ...
    st.caption(
        ...
        "Mit 'Kulturen' gelangst du nur bei unterstützten Urinmaterialien mit der "
        ...
        "aber aktuell nicht über einen Kulturworkflow mit Beurteilung und Befund "
        "weiterverarbeitet."
    )
